...
$(document).ready(function(){
	...
	$(".nav-item3").mouseenter(function(){
		 $(".colorband-three").css("height", "100%");
	...
	$(".nav-item7").mouseenter(function(){
		 $(".colorband-seven").css("height", "100%");
	...
	$(".nav-item8").mouseenter(function(){
		 $(".colorband-eight").css("height", "100%");
	...
	$(".nav-item9").mouseenter(function(){
		 $(".colorband-nine").css("height", "100%");
	...
	$(".nav-item10").mouseenter(function(){
		 $(".colorband-ten").css("height", "100%");
