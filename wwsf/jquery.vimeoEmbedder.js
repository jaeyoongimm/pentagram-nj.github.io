...
$( document ).ready(function() {
		var vimeoID = "72497724"; // specify Vimeo video ID to be played
		var width = 600px; // define WIDTH of Vimeo video canvas
		var height = 400px;	 // define HEIGHT of Vimeo video canvas
